...
export const NAV_GROUPS: NavGroup[] = [
  {
    ...
    items: [
      ...
      { label: "Competitor Intelligence", href: "/dashboard/seo/competitor-intelligence", icon: Users2 },
      { label: "Content Studio", href: "/dashboard/seo/content-studio", icon: FileText },
      { label: "Technical SEO Auditor", href: "/dashboard/seo/technical-audit", icon: Gauge },
      { label: "Internal Linking Engine", href: "/dashboard/seo/internal-linking", icon: Workflow },
      ...
      { label: "LLM / GEO Optimization", href: "/dashboard/seo/llm-optimization", icon: Sparkle },
      { label: "SEO Command Center", href: "/dashboard/seo/command-center", icon: CommandCenterIcon },
      { label: "AI SEO Assistant", href: "/dashboard/seo/assistant", icon: Sparkle, badge: "New" },
    ],
  },
  {
