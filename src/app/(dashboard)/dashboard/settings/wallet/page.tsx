    ...
    <div className="max-w-2xl space-y-6">
      <div>
        ...
        <p className="mt-1 text-sm text-neutral-500">
          Prepaid credits for platform-managed AI usage \u2014 spent only when you&apos;re using
          AIDigiMarket&apos;s shared key (Settings \u2192 My API Keys set to &quot;Platform-managed&quot;).
          Your own key never touches this balance.
        </p>
      </div>
